...
url_host= "https://1343498839394611.cn-hangzhou.fc.aliyuncs.com/2016-08-15/proxy/a/OneDrive/"
#http触发器的接口url


access_key='LTAI4G9kjhrsJjpmrrreWuyD'#云账号的AccessKey
access_key_secret='ShyxqEthoUtVkNuyVo4gW68IqWUfgU'#云账号AccessKey的密码
oss_end_point= 'http://oss-cn-shanghai-internal.aliyuncs.com'#访问对象存储的endpoint
oss_bucket_name='1index'#可以使用的对象存储桶名称
